    ...
    return (
        <SimpleGrid columns={{base: 1, sm: 1, lg: 3}} spacing={4}>
            ...
            <Card w={'full'} textAlign={'center'} _dark={{ bg: 'primary.1000', borderWidth: '1px', borderColor: 'primary.800' }}>
                ...
                <CardFooter py={0} px={0} w="full">
                    <Button as={Link} to={'#'} size='lg' borderRadius={'none'} borderBottomRadius={'md'} rightIcon={<ArrowRightIcon />} variant='ghost' bgGradient={'linear(to-r, blue.600, blue.800)'} _hover={{ bgGradient: 'linear(to-r, blue.700, blue.900)'}} w="full" justifyContent={'space-between'} color="white">
            ...
            <Card w={'full'} textAlign={'center'} _dark={{ bg: 'primary.1000', borderWidth: '1px', borderColor: 'primary.800' }}>
                ...
                <CardFooter py={0} px={0} w="full">
                    <Button as={Link} href={'#'} size='lg' borderRadius={'none'} borderBottomRadius={'md'} rightIcon={<ArrowRightIcon />} variant='ghost' bgGradient={'linear(to-r, purple.600, purple.800)'} _hover={{ bgGradient: 'linear(to-r, purple.700, purple.900)'}} w="full" justifyContent={'space-between'} color="white">
